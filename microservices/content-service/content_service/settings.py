...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ClientNest Content Service API',
...
SERVICE_URLS = {
    ...
    'AI_SERVICE': config('AI_SERVICE_URL', default='http://localhost:8004'),
    'ANALYTICS_SERVICE': config('ANALYTICS_SERVICE_URL', default='http://localhost:8005'),
    'NOTIFICATION_SERVICE': config('NOTIFICATION_SERVICE_URL', default='http://localhost:8006'),
}

# Service Authentication
SERVICE_SECRET_KEY = config('SERVICE_SECRET_KEY', default='service-secret-key-change-in-production')
...
MAX_POST_LENGTH = 2200  # Twitter's limit
MAX_HASHTAGS = 30
