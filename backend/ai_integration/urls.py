...
from .views import AITaskViewSet, ContentGenerationViewSet, SentimentAnalysisViewSet
...
# - GET /api/ai/tasks/usage_stats/ - Get usage statistics
#
# Content Generation:
# - POST /api/ai/content/ - Generate content (generic endpoint)
# - POST /api/ai/content/generate_post/ - Generate social media post
# - POST /api/ai/content/generate_caption/ - Generate image caption
