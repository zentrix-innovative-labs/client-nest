...
class PostAnalytics(models.Model):
    post = models.ForeignKey('content.Post', on_delete=models.CASCADE, related_name='analytics')
    ...
    def __str__(self):
        return f"Analytics for {self.post.title} on {self.social_account.platform}"
